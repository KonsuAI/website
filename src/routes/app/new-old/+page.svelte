...
<Page
	class="grid h-screen max-h-screen grid-rows-[max-content_1fr_max-content] mx-0"
	title="Welcome back, traveller"
>

	<div class="box-border flex flex-col items-center">
		<div>Popular right now.</div>
		<div class="box-border grid w-full max-w-200 grid-cols-1 gap-4 md:grid-cols-2">
			<SuggestedPlace
				title="Amalfi Coast"
	...
	<AiInput
		class="rounded-[0] border-l-0 border-b-0 border-r-0 ui-glow-reset"
